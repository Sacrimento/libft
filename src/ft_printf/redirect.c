...
static char		*redirect4(t_arg arg, va_list ap)
{
	...
	{
		if (arg.flag == 0)
			return (ft_umax_itoa_base(va_arg(ap, unsigned int), 16));
		else if (arg.flag == 'l')
			...
			return (ft_umax_itoa_base((unsigned short)va_arg(ap, int), 16));
		else if (arg.flag == 'H')
			return (ft_umax_itoa_base((unsigned char)va_arg(ap, int), 16));
		else if (arg.flag == 'j')
...
static char		*redirect3(t_arg arg, va_list ap)
{
	...
	{
		if (arg.flag == 0)
			return (ft_umax_itoa_base(va_arg(ap, unsigned int), 10));
		else if (arg.flag == 'l')
			...
			return (ft_umax_itoa_base((unsigned short)va_arg(ap, int), 10));
		else if (arg.flag == 'H')
			return (ft_umax_itoa_base((unsigned char)va_arg(ap, int), 10));
		else if (arg.flag == 'j')
...
static char		*redirect2(t_arg arg, va_list ap)
{
	...
	{
		if (arg.flag == 0)
			return (ft_umax_itoa_base(va_arg(ap, unsigned int), 8));
		else if (arg.flag == 'l')
			...
			return (ft_umax_itoa_base((unsigned short)va_arg(ap, int), 8));
		else if (arg.flag == 'H')
			return (ft_umax_itoa_base((unsigned char)va_arg(ap, int), 8));
		else if (arg.flag == 'j')
...
char			*redirect(t_arg arg, va_list ap)
{
	...
	else if (arg.spe == 'i' || (arg.spe == 'd' && arg.flag != 'a'))
	{
		if (arg.flag == 'l')
			...
			return (ft_max_itoa_base(va_arg(ap, int), 10));
		else if (arg.flag == 'h')
			return (ft_max_itoa_base((short)va_arg(ap, int), 10));
		else if (arg.flag == 'H')
			return (ft_max_itoa_base((signed char)va_arg(ap, int), 10));
		else if (arg.flag == 'z')
